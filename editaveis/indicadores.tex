...
\subsection{Qualidade de equipe}
	...
	\begin{tabular}{ |p{3cm}|p{12cm}| }
		...
		\hline
		\textbf{Fórmula} & QE = $\frac{\sum_{i=1}^{i=n}P_i}{\sum_{i=1}^{i=m}H_i}$ \begin{itemize}
  		\item n = número de artefatos entregues
		\item m = número de desenvolvedores da equipe
	  	\item $P_i$ = Pontuação do artefato entregue i
		\item $H_i$ = Horas trabalhadas pelo desenvolvedor i
		\end{itemize}\\
		\hline
		\textbf{Escala} & Racional \\
		\hline
